...
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/MarketplaceApp.md" "MarketplaceApp proof surface must mention the dependency-free graph."
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/MessagingApp.md" "MessagingApp proof surface must mention the dependency-free graph."
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/BookingReservationsApp.md" "BookingReservationsApp proof surface must mention the dependency-free graph."
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/NotesKnowledgeApp.md" "NotesKnowledgeApp proof surface must mention the dependency-free graph."
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/CreatorShortVideoApp.md" "CreatorShortVideoApp proof surface must mention the dependency-free graph."
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/TeamCollaborationApp.md" "TeamCollaborationApp proof surface must mention the dependency-free graph."
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/CRMAdminApp.md" "CRMAdminApp proof surface must mention the dependency-free graph."
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/SubscriptionLifestyleApp.md" "SubscriptionLifestyleApp proof surface must mention the dependency-free graph."
require_pattern 'no external dependency lockfile is required today' "${repo_root}/Documentation/App-Proofs/PrivacyVaultApp.md" "PrivacyVaultApp proof surface must mention the dependency-free graph."
require_pattern 'Templates/SocialMediaApp/Package\.resolved' "${repo_root}/Documentation/App-Proofs/SocialMediaApp.md" "SocialMediaApp proof surface must mention the lockfile."
require_pattern 'Templates/FitnessApp/Package\.resolved' "${repo_root}/Documentation/App-Proofs/FitnessApp.md" "FitnessApp proof surface must mention the lockfile."
require_pattern 'Templates/ProductivityApp/Package\.resolved' "${repo_root}/Documentation/App-Proofs/ProductivityApp.md" "ProductivityApp proof surface must mention the lockfile."
require_pattern 'Templates/FinanceApp/Package\.resolved' "${repo_root}/Documentation/App-Proofs/FinanceApp.md" "FinanceApp proof surface must mention the lockfile."
require_pattern 'Templates/EducationApp/Package\.resolved' "${repo_root}/Documentation/App-Proofs/EducationApp.md" "EducationApp proof surface must mention the lockfile."
require_pattern 'Templates/FoodDeliveryApp/Package\.resolved' "${repo_root}/Documentation/App-Proofs/FoodDeliveryApp.md" "FoodDeliveryApp proof surface must mention the lockfile."
require_pattern 'Templates/TravelPlannerApp/Package\.resolved' "${repo_root}/Documentation/App-Proofs/TravelPlannerApp.md" "TravelPlannerApp proof surface must mention the lockfile."
require_pattern 'Templates/AIAssistantApp/Package\.resolved' "${repo_root}/Documentation/App-Proofs/AIAssistantApp.md" "AIAssistantApp proof surface must mention the lockfile."
...
require_pattern 'Package\.resolved' "${repo_root}/Templates/SocialMediaApp/README.md" "SocialMediaApp template README must mention the lockfile."
require_pattern 'Package\.resolved' "${repo_root}/Templates/FitnessApp/README.md" "FitnessApp template README must mention the lockfile."
require_pattern 'Package\.resolved' "${repo_root}/Templates/ProductivityApp/README.md" "ProductivityApp template README must mention the lockfile."
require_pattern 'Package\.resolved' "${repo_root}/Templates/FinanceApp/README.md" "FinanceApp template README must mention the lockfile."
require_pattern 'Package\.resolved' "${repo_root}/Templates/EducationApp/README.md" "EducationApp template README must mention the lockfile."
require_pattern 'Package\.resolved' "${repo_root}/Templates/FoodDeliveryApp/README.md" "FoodDeliveryApp template README must mention the lockfile."
require_pattern 'Package\.resolved' "${repo_root}/Templates/TravelPlannerApp/README.md" "TravelPlannerApp template README must mention the lockfile."
require_pattern 'Package\.resolved' "${repo_root}/Templates/AIAssistantApp/README.md" "AIAssistantApp template README must mention the lockfile."
